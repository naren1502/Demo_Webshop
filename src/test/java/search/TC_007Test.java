...
public class TC_007Test extends BaseUnit {
	@DataProvider(name="TC_007")
	public String[][] data() {
		return ReadData.readDataExcel("testData", 6);
	}

	@Test(dataProvider = "TC_007")
	public void filterByPrice(String[]data) {  
		...
		electronics.getOver500FilterByPrice().click();
		...
		Assert.assertEquals(check, true, "the product value is less than 500");
		Reporter.log("The product is displayed successfully over 500 price range",true);
